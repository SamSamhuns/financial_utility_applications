...
def daily_returns( eticker ):
    ...
    eticker['10 DMA'] = eticker['Daily Returns'].rolling( window=10 ).mean()    # 10 day moving average
    eticker['30 DMA'] = eticker['Daily Returns'].rolling( window=30 ).mean()    # 30 day moving average
...
def weekly_returns( eticker ):
    ...
    eticker['4 WMA'] = eticker['Weekly Returns'].rolling( window=4 ).mean()     # 4 weeks moving average
